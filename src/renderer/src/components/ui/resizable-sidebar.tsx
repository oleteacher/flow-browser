...
function SidebarProvider({
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      if (
        SIDEBAR_KEYBOARD_SHORTCUT_ENABLED &&
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l border-gray-400/40",
          className
        )}
        {...props}
      >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        !enableDrag && "in-data-[side=left]:cursor-w-resize in-data-[side=right]:cursor-e-resize",
        enableDrag && "in-data-[side=left]:cursor-col-resize in-data-[side=right]:cursor-col-resize",
