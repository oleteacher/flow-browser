...
curl -LO https://github.com/MultiboxLabs/flow-browser/releases/download/v0.6.1/flow-browser-0.6.0.dmg && open .
```

### Windows:

Download [FlowSetup.exe](https://github.com/MultiboxLabs/flow-browser/releases/download/v0.6.1/flow-browser-0.6.0-setup.exe)
