...
curl -LO https://github.com/MultiboxLabs/flow-browser/releases/download/v0.4.1/FlowInstaller.dmg && open .
```

### Windows:

Download [FlowSetup.exe](https://github.com/MultiboxLabs/flow-browser/releases/download/v0.4.1/FlowSetup.exe)
