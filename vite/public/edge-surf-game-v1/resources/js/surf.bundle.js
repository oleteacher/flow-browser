    ...
    t = {
      ...
      13695: (e, t, s) => {
        ...
        class Y {
          constructor() {
            ...
            (Y.offline = this), this.loadData(), re.subscribe(this.loadData.bind(this));
          }
          loadData() {
            const e = re.getState();
            this.localData = {
        ...
        class te {
          constructor() {
            if ((J(this, "session", void 0), J(this, "game", void 0), te.sys)) return te.sys;
            (te.sys = this),
        ...
        const se = 1,
          ie = {
            ...
            timetrial_bestScore:
              Z.pz.getInteger("timetrialBestScore") < 0 ? -1 : Z.pz.getInteger("timetrialBestScore") / 1e3,
        ...
        class he {
          ...
          static async getAllStats() {
            ...
            return "undefined" != typeof Z.e9 &&
              ...
              : Promise.resolve(JSON.parse(localStorage.getItem("stats")) || he.defaultStats());
          ...
          static saveEndlessHighScore(e) {
            ...
            if ("undefined" != typeof Z.e9 && "function" == typeof Z.e9.send) {
              ...
              localStorage.setItem(
                "stats",
                JSON.stringify(
                  Object.assign(Object.assign({}, JSON.parse(localStorage.getItem("stats"))), {
                    endless_bestScore: e
                  })
                )
              );
        ...
        class de {
          ...
          createBackground() {
            (this.canvas = ue.sys.createNewCanvas()),
              ...
              (this.gradient = ue.sys.createNew("div", document.body, "game-gradient")),
          ...
          drawLayer(e, t, s = 0, i = 0, a = 0, o = "looping", n) {
            ...
            if (
              ...
              ("oneshot" === o || "ending" === o) && Math.ceil(a * r.fps) > l.length - 1)
            )
              switch (o) {
                case "oneshot":
                  n.anim = "paused";
          ...
          drawShield(e, t) {
            const s = te.sys.game.shields.current / te.sys.game.shields.max / 2 + 0.5,
            ...
            r.beginPath(),
              ...
              (r.strokeStyle = "rgba(" + pe.sys.accent + "," + (6 - i) / 4 + ")"),
              (r.lineWidth = 6 - i),
              r.stroke(),
              r.beginPath(),
          ...
          drawPickup(e) {
            ...
            a.beginPath(),
              ...
              (a.strokeStyle = "rgba(" + pe.sys.accent + "," + (1 - 2 * t) + ")"),
              (a.lineWidth = 6 * (1 - 2 * t)),
              a.stroke();
          }
          drawHitbox(e, t) {
        ...
        class pe {
          ...
          setNewTheme(e) {
            ...
            (this.objectsImg.src = this.objectsTemp.src),
              ...
              (de.sys.bg.style.backgroundSize = this.bgSize + "px " + this.bgSize + "px");
            const s = this.gradient.start.join(", "),
              i = this.gradient.end.join(", ");
            (de.sys.gradient.style.background = "linear-gradient(180deg, rgb(" + s + ") 0%, rgb(" + i + ") 100%)"),
        ...
        class ue {
            ...
            switch (t) {
              ...
              case ee.Keyboard:
                this.instructAction.classList.add("outline"),
                  (this.instructAction.textContent = Z.pz.getString(t + "Action"));
                break;
              case ee.Ps:
              case ee.Xbox: {
                const e = t + "Action";
            ...
            switch (((this.notifyContent.textContent = ""), e)) {
              ...
              case "score": {
                ...
                (this.notifyContent.textContent = Z.pz.getStringF(
                  ...
                  this.createIconSVG(this.notifyContent, "star", 20, "0 4px 0 0");
                break;
              }
              case "cheatcode":
          ...
          createShareLink() {
            ...
            (this.createNew("p", e, "notify-shareText").textContent = Z.pz.getString("shareCopy")),
              this.createIconSVG(e, "link", 20, "0 4px 0 0");
          }
          copyShareLink() {
            $(Z.pz.getString("shareLink")), (this.notifyContent.textContent = Z.pz.getString("shareLinkCopied"));
          }
          showNotification() {
          ...
          checkHighScoreIcon() {
            ...
            (this.scoreIcon.textContent = ""),
              (e === Q.Menu || te.sys.game.highScore) && this.createIconSVG(this.scoreIcon, "star", 20);
          }
          updateScore() {
            const e = te.sys.session.settings.mode;
          ...
          updateIcons() {
            ...
            if (s.lives || s.safety) s.safety && e.push("shield"), e.push("life-full"), e.push("infinite");
              ...
              for (let t = 1; t <= te.sys.game.lives.max; t++) {
                let s = "life-empty";
                t <= te.sys.game.shields.current ? (s = "shield") : t <= te.sys.game.lives.current && (s = "life-full"),
                  e.push(s);
              }
        ...
        class ye {
          constructor() {
            if ((me(this, "legend", void 0), me(this, "spawnSingle", void 0), me(this, "library", void 0), ye.sys))
              return ye.sys;
        ...
        class ve extends we {
          ...
          draw() {
            this.pickup
              ...
              : (void 0 !== this.fx && "hidden" !== this.anim && de.sys.drawFx(this.time, this.x, this.y + this.fx),
                de.sys.drawLayer(this.type, this.pose, this.x, this.y, this.time, this.anim, this),
                void 0 !== this.decor && de.sys.drawLayer("wallDecor", this.decor, this.x, this.y - 24));
          }
        }
        class xe extends ve {
          constructor(e, t, s, i) {
          ...
          isCrashed() {
            return (
              !(this.timer.crash <= 0) &&
              ((this.timer.crash -= te.sys.game.time.loop * te.sys.game.time.scale),
          ...
          changeState(e) {
            ...
            (this.pose = e),
              ...
              "crash" === e && ((this.timer.crash += 1.5), (this.speed.raw = 0));
          }
          updateDirection() {
        ...
        class Se extends ve {
          ...
          updateDirection() {
            if (
              ((this.dist = Math.hypot(te.sys.session.x - this.x, te.sys.session.y - this.y)),
              (this.timer.dir -= te.sys.game.time.loop * te.sys.game.time.scale),
              this.timer.dir <= 0)
            ) {
        ...
        class ke {
          ...
          createFoe() {
            ...
            this.buildObject("foe", e, -32, "chase").speed.raw = ze.sys.speed.raw + 1;
          }
          buildStartScene() {
          ...
          nextReady(e, t = !0) {
            let s;
            return (
              (s = t ? te.sys.game.dist.unit : te.sys.game.dist.y + (te.sys.session.h - te.sys.session.y)),
          ...
          createEndlessRow() {
            ...
            for (; a <= i; a++) {
              ...
              "left" === e.dir || "downleft" === e.dir
                ? (r = -this.grid.gap / 4)
                : ("right" !== e.dir && "downright" !== e.dir) || (r = this.grid.gap / 4);
          ...
          buildEndlessRandomSnags(e, t) {
            ...
            for (let s = 0; s < o; s++) {
              ...
              let n = "snag";
              Math.random() < 0.5 && (n = te.sys.randIndex(Object.keys(ye.sys.spawnSingle)));
          ...
          createZigZagStart() {
            this.buildCluster("zigzagGates", te.sys.session.x, te.sys.session.y + 512, "gateFirst"),
          ...
          createGateClusters(e, t, s) {
            ...
            if ((this.buildCluster("zigzagGateScenes", e, a), this.nextReady(this.zigzag.life)))
              this.buildObject("life", e, a, "life");
            else if (this.nextReady(this.zigzag.boost)) this.buildObject("boost", e, a, "boost");
            else if (Math.random() < 0.1) this.buildObject("spiral", e, a, "spiral1");
          ...
          buildCluster(e, t, s, i) {
            if (!i) {
              const t = Object.keys(ye.sys.library[e]).filter((e) => !this.prevClusters.includes(e));
            ...
            for (const e in a)
              if (a.hasOwnProperty(e)) {
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  if (o.length > 2) {
                    const t = o[2];
                    n = "string" == typeof t ? te.sys.randIndex(ye.sys.legend[e][t]) : t[0];
                  } else {
          ...
          buildCrashedFriend(e, t) {
            (this.buildObject("friend", e, t, "crash").hit = !0),
              (this.endless.friend.next = te.sys.game.dist.unit + this.endless.friend.inc);
          }
          buildCheckpoint(e, t) {
          ...
          buildObject(e, t, s, i) {
            (t = Math.floor(t) + (te.sys.game.dist.x - Math.floor(te.sys.game.dist.x))),
              (s = Math.floor(s) + (te.sys.game.dist.y - Math.floor(te.sys.game.dist.y)));
            let a = this.wake(e, t, s, i);
            switch ((a || (a = this.createObject(e, t, s, i)), a.type)) {
              case "wall":
                !["f1", "f2", "f3"].includes(i) &&
                  Math.random() < 0.5 &&
                  (a.decor = te.sys.randIndex(["a", "b", "c", "d", "e", "f", "g", "h"]));
                break;
              case "ambient":
                a.anim = "hidden";
                break;
          ...
          wakeFromSleep(e, t) {
            let s = this.sleeping;
            const i = s.length;
            for (let a = 0; a < i; a++) if (s[a].type === e) return (s[a].pose = t), (s = s.splice(a, 1)), s[a];
            return null;
          }
          putToSleep() {
        ...
        class Me {
          constructor() {
            if (
              ...
              return Me.sys;
            (Me.sys = this),
              window.addEventListener("gamepadconnected", (e) => Me.sys.onGamepadConnected(e)),
              window.addEventListener("gamepaddisconnected", (e) => Me.sys.onGamepadDisconnected(e)),
              (this.indexList = []),
              (this.buttonMap = [
                "a",
                "b",
          ...
          onGamepadDisconnected(e) {
            ...
            (s !== ee.Xbox && s !== ee.Ps) || Ae.sys.changeInputMethod(ee.Keyboard);
          }
          setController(e, t) {
            (this.linkedPad = {
              index: e,
          ...
          checkButtons(e) {
            ...
            if (t(e.buttons[4]) && t(e.buttons[5]))
              return (
                Ae.sys.routeInput(He.Reset), (this.linkedPad.pressed.lb = !0), void (this.linkedPad.pressed.rb = !0)
              );
            let s;
            ...
            for (let a = 0; a < i; a++)
              if (t(e.buttons[a])) {
                ...
                if (
                  ...
                  this.changeControllerType(e),
                  te.sys.session.flyoutActive && ["a", "b", "up", "down"].includes(this.buttonMap[a]))
                ) {
        ...
        class Pe {
          ...
          onMouseMove(e) {
            if (te.sys.session.state === Q.Play) {
              ...
              this.mousePos !== t && ((this.mousePos = t), Ae.sys.routeInput(t, !0, !1));
            }
          }
          onContextMenu(e) {
            e.preventDefault(), te.sys.session.state === Q.Play && Ae.sys.routeInput(He.Boost, !1, !1);
          }
          checkAngle(e, t) {
        ...
        class ze extends ve {
          ...
          checkBoundaries() {
            ...
            switch (t) {
              ...
              case q.ZigZag:
                ...
                break;
              case q.Endless:
                e.y < 8e3 && e.x < -6400 && !ke.sys.swapBuilt && ke.sys.buildSwap(),
          ...
          changeCharacter(e, t = !1) {
            ...
            t || (e = (s.length + te.sys.session.settings.character + e) % s.length), (this.skins.render = []);
          ...
          changeDirection(e, t = !1) {
            ...
            switch (
              (t || "left" !== e || "left" === this.dir
                ? t || "right" !== e || "right" === this.dir || (e = "downright" === this.dir ? "right" : "downright")
          ...
          updateTrackers() {
            this.timer.crash &&
              ((this.timer.crash -= te.sys.game.time.loop * te.sys.game.time.scale),
              this.timer.crash < 0 && ((this.timer.crash = void 0), this.stop(), Pe.sys.reset()));
            for (const e in this.dist)
              (this.dist[e] -= this.speed.current), this.dist[e] <= 0 && (delete this.dist[e], this.endDistTracker(e));
          }
          updateSpeed() {
            let e = 1;
            const t = this.speed;
          ...
          stop() {
            this.changeDirection("stop"), this.stopPlayerSpeed(), Me.sys.setVibration("tiny");
          }
          down() {
            "air" in this.dist
          ...
          crash() {
            ...
            te.sys.game.friend &&
              !e.safety &&
              (this.removeFriend(), ke.sys.buildCrashedFriend(this.x + 48 * (Math.random() - 0.5), this.y + 32)),
          ...
          boost(e = !1) {
            (!e && (te.sys.game.boosts.current <= 0 || "boost" in this.dist)) ||
              (e || te.sys.game.cheat.boosts || (te.sys.game.boosts.current -= 1),
              (this.dist.boost = 2e3),
          ...
          collectFriend() {
            (te.sys.game.friend = !0),
              ...
              te.sys.session.settings.mode === q.Endless &&
                ((te.sys.game.shields.current = te.sys.game.shields.max), ue.sys.refreshDisplay()),
              Me.sys.setVibration("pickup");
          }
          removeFriend(e = !1) {
            !te.sys.game.friend ||
          ...
          useShield() {
            te.sys.game.cheat.safety ||
              ((te.sys.game.shields.current -= 1), ue.sys.refreshDisplay(), Me.sys.setVibration("small"));
          }
          lose() {
            (te.sys.game.lives.current = 0),
              (te.sys.game.shields.current = 0),
          ...
          failGate(e) {
            te.sys.game.highScore && (ue.sys.sendNotification("score"), (te.sys.game.highScore = !1)),
              (te.sys.game.gates = 0),
              (this.previousGate = e),
              ue.sys.refreshDisplay(),
              Me.sys.setVibration("slow");
          ...
          renderCharacterSelection() {
            ...
            for (let o = 0; o < t; o++) {
              ...
              if (o !== s)
                (l = "down"), de.sys.drawPlayerMenu(h, l, te.sys.session.x + t * (o - s), te.sys.session.y, n + r);
              else {
                n = this.scale;
                te.sys.game.shields.current / te.sys.game.shields.max > 0 && de.sys.drawShield(this.x, this.y + 16),
                  de.sys.drawPlayerSprite(l, e, te.sys.session.x + t * (o - s), te.sys.session.y, n + r);
              }
            }
            a.restore();
          }
          draw() {
            if ((this.boostFx.length > 0 && de.sys.drawBoost(this.boostFx), this.swapped))
              de.sys.drawLayer("foe", this.pose, this.x, this.y, this.time, this.anim);
            else {
              const e = te.sys.game.time.elapsed;
              te.sys.game.shields.current / te.sys.game.shields.max > 0 && de.sys.drawShield(this.x, this.y + 16),
                "air" in this.dist &&
                ...
                "immune" in this.dist &&
                  (de.sys.ctx.save(), (de.sys.ctx.globalAlpha = Math.floor(4 * e) % 2 == 0 ? 0.4 : 0.7)),
                de.sys.drawPlayerSprite(this.pose, e, this.x, this.y, this.scale),
        ...
        class De {
          constructor() {
            ...
            (De.sys = this),
              window.addEventListener("keydown", (e) => De.sys.onKeydown(e), !1),
        ...
        class Oe {
          constructor() {
            if (
              ...
              return Oe.sys;
            (Oe.sys = this),
              window.addEventListener("touchstart", (e) => Oe.sys.onTouchStart(e), !1),
              window.addEventListener("touchmove", (e) => Oe.sys.onTouchMove(e), !1),
              window.addEventListener("touchend", (e) => Oe.sys.onTouchEnd(e), !1),
              this.reset();
          }
          reset() {
            (this.swipeStart = 0),
          ...
          onTouchStart(e) {
            if (!this.interact(e) && (Ae.sys.changeInputMethod(ee.Touch), e.targetTouches)) {
          ...
          onTouchMove(e) {
            ...
            if (
              ...
              this.touchPos !== e && ((this.touchPos = e), Ae.sys.routeInput(e, !0, !1));
            }
          }
          onTouchEnd(e) {
            if (this.interact(e)) return;
        ...
        class Ae {
          constructor() {
            if (
              ...
              return Ae.sys;
            (Ae.sys = this), new Me(), new De(), new Pe(), new Oe(), this.defineCodes(), this.reset();
          }
          reset() {
            Me.sys.reset(),
              Pe.sys.reset(),
          ...
          routeInput(e, t = !1, s = !0) {
            if (te.sys.session.flyoutActive) return void (e === He.Settings && this.inputSettings());
            const i = te.sys.session.inputType;
            let a = !1;
            if ((s && (a = this.registerDoubleInput(e)), (i !== ee.Mouse && i !== ee.Touch) || e !== He.Toggle || a))
              if (
                ((i !== ee.Keyboard && i !== ee.Touch) || e !== He.Down || t || !a
                  ? i === ee.Touch && a && (e = He.Toggle)
                  : (e = He.Boost),
                te.sys.session.state !== Q.Menu || (e !== He.Left && e !== He.Right))
              )
                switch (e) {
                  case He.Toggle:
                    this.inputToggle();
          ...
          registerDoubleInput(e) {
            ...
            let t = !1;
            return (
              this.thisTime - this.lastTime <= this.doubleDelta && this.lastInput === e && ((t = !0), (e = void 0)),
          ...
          changeInputMethod(e) {
            te.sys.session.inputType === e ||
              ...
              ((this.lastInputTime = Date.now()), (te.sys.session.inputType = e), ue.sys.updateInputTypeUI());
          }
          inputToggle() {
            const e = te.sys.session.state;
            e === Q.Play
          ...
          cheat(e, t = !0) {
            ...
            s.lives || s.boosts || s.safety || (s.used = !1), ue.sys.updateIcons();
          }
        }
        Re(Ae, "sys", null);
        class Ne {
          ...
          checkCollisions() {
            ...
            function o(e, t) {
              if (!(e.y < 16) && Ne.sys.collision(t, e) && !t.objectsHit.includes(e))
            ...
            for (let n = 0; n < a; n++) {
              ...
              if (!this.collision(e, a) || a.hit || t)
                "gate" === a.type && !a.hit && a.y < e.y
                  ? (e.failGate(a.gateId), ke.sys.denyGate(a.gateId), (a.hit = !0))
                  : "ambient" === a.type && "hidden" === a.anim && a.y + 32 < e.y
                    ? ((a.anim = "oneshot"), (a.time = 0))
                    : "lure" === a.type &&
                      a.hit &&
                      a.y + 192 < e.y &&
                      (ke.sys.buildObject("foe", a.x, a.y + 32, "chase"), (a.sleep = !0));
              else {
                if (((a.hit = !0), e.swapped))
                  return "lure" === a.type && ke.sys.buildObject("foe", a.x, a.y, "chase"), void (a.sleep = !0);
                switch (a.type) {
                  case "wall":
                  case "snag":
                  case "snagsml":
                  ...
                  case "gate": {
                    ...
                    (t.hit = !0), this.collectAnim(t), ke.sys.confirmGate(a.gateId);
                    break;
                  }
                  case "finish":
                    e.finishline();
          ...
          filterVisible(e) {
            return e.filter((e) =>
              (function (e) {
                return (
                  (e.y > -64 && e.y < te.sys.session.h + 64 && e.x > -64 && e.x < te.sys.session.w + 64) ||
                  "gate" === e.type
                );
              })(e)
            );
        ...
        class Ze {
          ...
          triggerPlay(e) {
            e === Q.Menu && this.triggerStart(), ue.sys.hideOverlayUI(), ue.sys.refreshDisplay();
          }
          triggerStart() {
          ...
          triggerOver() {
            ke.sys.all.forEach((e) => {
              ...
              (te.sys.session.settings.mode !== q.TimeTrial || te.sys.game.finish) && te.sys.saveGameStats();
          ...
          render() {
            if ((de.sys.clearCanvas(), te.sys.session.state === Q.Menu)) return void ze.sys.renderCharacterSelection();
            ...
            e.forEach((e) => {
              ...
              te.sys.session.settings.mode !== q.Endless && de.sys.drawBoundaries();
          }
        }
        !(function (e, t, s) {
          t in e
        ...
        class Je extends O.Z {
          constructor(...e) {
            super(...e),
              ...
              Xe(this, "renderHowToPlayContent", () =>
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement("strong", null, Z.pz.getString("endlessModeTitleInline")),
                    " ",
                  ...
                  a.createElement(
                    ...
                    a.createElement("strong", null, Z.pz.getString("timetrialModeTitleInline")),
                    " ",
                  ...
                  a.createElement(
                    ...
                    a.createElement("strong", null, Z.pz.getString("zigzagModeTitleInline")),
                    " ",
              ...
              Xe(this, "onInputIconKeydown", (e) => {
                ...
                if (e.keyCode === qe.mW.arrowLeft || e.keyCode === qe.mW.arrowUp)
                  ...
                  if (e.keyCode !== qe.mW.arrowRight && e.keyCode !== qe.mW.arrowDown) return;
                  switch (this.state.selectedInput) {
                    case "keyboard":
                      t = "mouse";
                      break;
          ...
          renderInputIcons() {
            const e = [
              ...
              return (
                i && (o += ` ${this.props.managedClasses.howToPlayModal_inputButton__selected}`),
                a.createElement(
                  k.XC,
                  {
                    role: "radio",
        ...
        class ht extends O.Z {
          constructor(e) {
            super(e),
              ...
              at(this, "toggleSettingsMenu", () => {
                this.state.menuOpen || this.props.gameState !== Q.Play || Ze.sys.changeGameState(Q.Pause),
                  this.setState({
              ...
              at(this, "resetStats", () => {
                this.props.dispatch(ne()), he.resetAllStats(), ue.sys.refreshDisplay(), this.closeModal();
          ...
          renderGameModePicker() {
            ...
            return a.createElement(
              "div",
              {
                className: this.props.managedClasses.settingsHamburgerMenu_flyout_row
              },
              a.createElement(
                E.__,
                {
                ...
                o ? Z.pz.getString("gameModeSelectLabelDisabled") : Z.pz.getString("gameModeSelectLabel")
              ),
              a.createElement(
                z.Ph,
                {
      ...
      81545: (e, t, s) => {
        ...
        class g extends i.Z {
            ...
            super(...arguments),
              ...
              (this.handleTabKeyDown = (e) => {
                ...
                e.shiftKey && e.target === t[0]
                  ...
                  : e.shiftKey || e.target !== t[s - 1] || (t[0].focus(), e.preventDefault());
              }),
              ...
              (this.focusOnFirstElement = () => {
                if ((0, n.N)() && this.rootElement.current instanceof HTMLElement) {
              ...
              (this.invokeFocusOnCloseTarget = () => {
                ...
                if ((0, c.Z)(this.props.focusTargetOnClose)) return void this.props.focusTargetOnClose();
          ...
          componentDidUpdate(e) {
            (0, n.N)() &&
              (!e.modal && this.props.modal
                ? (document.addEventListener("focusin", this.handleDocumentFocus), this.focusOnFirstElement())
                : e.modal && !this.props.modal && document.removeEventListener("focusin", this.handleDocumentFocus),
              !this.shouldAddKeyListener(e) && this.shouldAddKeyListener(this.props)
                ? document.addEventListener("keydown", this.handleDocumentKeyDown)
          ...
          generateClassNames() {
            return super.generateClassNames((0, o.A)(this.props.managedClasses.dialog));
          }
          renderModalOverlay() {
            if (this.props.modal)
              return r.createElement("div", {
                className: (0, o.A)(this.props.managedClasses.dialog_modalOverlay),
      ...
      2057: (e, t, s) => {
        ...
        class l extends a.Z {
          ...
          render() {
            return n.createElement(
              "hr",
              Object.assign({}, this.unhandledProps(), this.generateAttributes(), {
                className: this.generateClassNames()
              })
            );
          }
          ...
          constructor() {
            super(...arguments),
              ...
              (this.isItemSelected = () => {
                ...
                return (
                  void 0 !== this.context.listboxSelectedItems &&
                    (e = 1 === this.context.listboxSelectedItems.filter((e) => e.id === this.props.id).length),
                  e
                );
              }),
              (this.handleKeyDown = (e) => {
                if (
                  !this.props.disabled &&
                  ("function" == typeof this.props.onKeyDown && this.props.onKeyDown(e), !e.defaultPrevented)
                )
                  switch (e.keyCode) {
                    case a.bq:
                    case a.ei:
      ...
      42999: (e, t, s) => {
        ...
        class g extends i.Z {
          constructor(e) {
            super(e),
              ...
              (this.setInitialFocus = (e, t) => {
                let s = -1;
                for (let t = 0; t < e.length; t++) s = g.getItemIndexById(e[t].id, this.props.children);
                ...
                return (
                  (e =
                    void 0 !== this.props.selectedItems
                      ? g.getListboxItemDataFromIds(this.props.selectedItems, this.props.children)
                      : g.getListboxItemDataFromIds(this.props.defaultSelection, this.props.children)),
                ...
                switch (e.keyCode) {
                  ...
                  default:
                    "A" === e.key
                      ...
                      : !e.ctrlKey && this.props.typeAheadEnabled && this.processTypeAhead(e);
                }
              }),
              (this.processTypeAhead = (e) => {
                ...
                d.Children.toArray(this.props.children).some(
                  (e, s) =>
                    ...
                    ((0, o.Ny)(e.props[this.props.typeAheadPropertyKey].toLowerCase(), this.typeAheadString)
                      ? ((t = s), !0)
                      : void 0)
                ),
                  -1 !== t
              ...
              (this.listboxItemInvoked = (e, t) => {
                ...
                this.props.multiselectable && "click" === t.type
                  ? ((t.shiftKey && -1 !== this.shiftRangeSelectStartIndex) || (this.shiftRangeSelectStartIndex = i),
                    t.ctrlKey
                      ? this.toggleItem(e)
                      : t.shiftKey
          ...
          static getItemIndexById(e, t) {
            return d.Children.toArray(t).findIndex(
              (t) => void 0 !== t.props[g.idPropertyKey] && t.props[g.idPropertyKey] === e
            );
          }
          ...
          componentDidUpdate(e) {
            ...
            if (
              ...
              if (!(0, h.Z)(this.rootElement.current) && this.rootElement.current.contains(document.activeElement))
                return void this.setState({
                  focusIndex: e.indexOf(document.activeElement)
                });
              (e.length <= this.state.focusIndex || !this.isFocusableElement(e[this.state.focusIndex])) &&
        ...
        (g.displayName = `${p.k}Listbox`),
          ...
          (g.getValidOptions = (e) => e.filter((e) => g.isValidSelectedItem(e))),
      ...
      63566: (e, t, s) => {
        ...
        class m extends i.Z {
          constructor(e) {
            super(e),
              ...
              (this.updateSelectionFromProps = () => {
                const e = this.trimSelection(
                  b.ZP.getListboxItemDataFromIds(this.props.selectedItems, this.props.children)
                );
                this.setState({
                  selectedItems: e,
              ...
              (this.trimSelection = (e) =>
                !1 === this.props.multiselectable && e.length > 1 ? [this.state.selectedItems[0]] : e),
              (this.getValueFromSelection = (e) =>
                this.props.multiselectable ? e.map((e) => e.value) : 0 === e.length ? "" : e[0].value),
              (this.getSelectedItemPosInSet = (e, t) => {
                if (!this.props.multiselectable && 1 === t.length) {
                  const s = t[0].id,
                    i = e.length;
                  for (let t = 0; t < i; t++) if (e[t].props[m.idPropertyKey] === s) return t + 1;
                }
                return 0;
              }),
                ...
                if (
                  ...
                  switch (e.keyCode) {
                    ...
                    case a.ei:
                      ...
                      break;
                    case a.Lp:
                      e.preventDefault(), this.toggleMenu(!1), this.focusTriggerElement();
                      break;
                    case a.Q6:
                    case a.ho:
                      e.preventDefault(),
              ...
              (this.handleMenuBlur = (e) => {
                this.state.isMenuOpen &&
                  ...
                  (!this.rootElement.current.contains(e.relatedTarget) ||
                    ((0, o.Re)(e.relatedTarget) && e.relatedTarget.id === this.triggerId)) &&
                  this.toggleMenu(!1);
              }),
              (this.getFormattedDisplayString = (e) =>
                void 0 === this.props.displayStringFormatter
                  ? this.defaultDisplayStringFormatter(e, this.props.placeholder)
                  : this.props.displayStringFormatter(e, this.props.placeholder)),
              (this.isFocusableButton = (e) =>
                e instanceof HTMLButtonElement && "true" !== e.getAttribute("aria-disabled")),
            ...
            let t = this.trimSelection(
              b.ZP.getListboxItemDataFromIds(
                void 0 !== this.props.selectedItems ? this.props.selectedItems : this.props.defaultSelection,
                this.props.children
              )
            );
          ...
          componentDidUpdate(e) {
            ...
            e.multiselectable !== this.props.multiselectable && ((t = !0), (s = this.checkPropsForMenuState())),
              ...
              e.selectedItems === this.props.selectedItems
                ? t && this.updateSelection(this.state.selectedItems.map((e) => e))
                : this.updateSelectionFromProps();
          }
          componentDidMount() {
          ...
          generateClassNames() {
            ...
            return super.generateClassNames(
              (0, n.A)(
                e,
                [t, !(0, c.Z)(this.props.menuFlyoutConfig) && this.props.menuFlyoutConfig.scaleToFit],
          ...
          renderTrigger() {
            return void 0 !== this.props.trigger
              ...
              : this.defaultTriggerRenderFunction(this.props, this.state, this.triggerId);
          }
          renderMenu() {
            ...
            super(e),
              ...
              (this.updateDisabledState = () => {
                (0, n.N)() && !0 !== this.props.disabled
                  ? (null === this.getAnchorElement() || null === this.getViewportElement(this.props.viewport)) &&
              ...
              (this.detachListeners = (e) => {
                ...
                (0, l.Z)(t) || t.removeEventListener("scroll", this.handleScroll),
                  this.collisionDetector &&
                    "function" == typeof this.collisionDetector.disconnect &&
                    (this.collisionDetector.disconnect(), (this.collisionDetector = null)),
                  this.resizeDetector &&
              ...
              (this.handleAnchorResize = (e) => {
                (this.anchorHeight = e.contentRect.height),
                  ...
                  this.state.currentVerticalPosition === g.top || this.state.currentVerticalPosition === g.insetTop
              ...
              (this.handleCollision = (e, t) => {
                ...
                e.forEach((t) => {
                  t.target === this.rootElement.current
                    ? (this.handlePositionerCollision(t, 1 === e.length), (s = t.boundingClientRect))
                    : this.handleAnchorCollision(t);
                });
                const i = this.getViewportElement(this.props.viewport);
                (0, l.Z)(i) || ((this.scrollTop = i.scrollTop), (this.scrollLeft = i.scrollLeft)),
                  ...
                  switch (this.state.currentHorizontalPosition) {
                    ...
                    case b.left:
                      this.baseHorizontalOffset =
                        this.baseHorizontalOffset + (this.anchorLeft + this.state.xTranslate - e.right);
                      break;
                    case b.insetLeft:
                      this.baseHorizontalOffset =
                        this.baseHorizontalOffset + (this.anchorRight + this.state.xTranslate - e.right);
                      break;
                    case b.insetRight:
                      this.baseHorizontalOffset =
                        this.baseHorizontalOffset + (this.anchorLeft + this.state.xTranslate - e.left);
                    ...
                    case b.right:
                      this.baseHorizontalOffset =
                        this.baseHorizontalOffset + (this.anchorRight + this.state.xTranslate - e.left);
                  }
                  ...
                  switch (this.state.currentVerticalPosition) {
                    ...
                    case g.top:
                      this.baseVerticalOffset =
                        this.baseVerticalOffset + (this.anchorTop + this.state.yTranslate - e.bottom);
                      break;
                    case g.insetTop:
                      this.baseVerticalOffset =
                        this.baseVerticalOffset + (this.anchorBottom + this.state.yTranslate - e.bottom);
                      break;
                    case g.insetBottom:
                      this.baseVerticalOffset =
                        this.baseVerticalOffset + (this.anchorTop + this.state.yTranslate - e.top);
                      break;
                    case g.bottom:
                      this.baseVerticalOffset =
                        this.baseVerticalOffset + (this.anchorBottom + this.state.yTranslate - e.top);
              ...
              (this.updateLayout = () => {
                ...
                if (this.props.horizontalPositioningMode !== d.tg.uncontrolled) {
                  ...
                  (t === b.undefined || (!this.props.horizontalLockToDefault && this.getAvailableWidth(t) < s)) &&
                    (t = this.getAvailableWidth(e[0]) > this.getAvailableWidth(e[1]) ? e[0] : e[1]);
                }
                if (this.props.verticalPositioningMode !== d.tg.uncontrolled) {
                  ...
                  (e === g.undefined || (!this.props.verticalLockToDefault && this.getAvailableHeight(e) < s)) &&
                    (e = this.getAvailableHeight(t[0]) > this.getAvailableHeight(t[1]) ? t[0] : t[1]);
                }
              ...
              (this.getNextPositionerDimension = (e, t) => {
                ...
                return (
                  this.props.scaleToFit &&
                    ((s.height = Math.max(
                      Math.min(this.getAvailableHeight(t), this.viewportRect.height),
                      (0, l.Z)(this.props.verticalThreshold) ? 0 : this.props.verticalThreshold
                    )),
                    (s.width = Math.max(
                      Math.min(this.getAvailableWidth(e), this.viewportRect.width),
                      (0, l.Z)(this.props.horizontalThreshold) ? 0 : this.props.horizontalThreshold
                    ))),
                  s
                );
              }),
              ...
              (this.getAnchorElement = () =>
                (0, l.Z)(this.props.anchor) ? null : this.extractElement(this.props.anchor)),
          ...
          componentDidUpdate(e) {
            if (e !== this.props) {
              if (e.anchor !== this.props.anchor || e.viewport !== this.props.viewport)
                return this.detachListeners(e.viewport), void this.setState(this.generateInitialState());
              this.requestFrame();
            }
            (e.disabled !== this.props.disabled || this.state.validRefChecksRemaining > 0) &&
              this.updateDisabledState();
          }
          render() {
            return h.createElement(
              ...
              this.props.disabled || this.state.initialLayoutComplete || !this.props.delayContentInstanciation
                ? this.props.children
                : null
            );
          }
